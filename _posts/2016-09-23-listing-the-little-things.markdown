...
<figure markdown="1">
[![A screenshot of the "Bedtime" tab in the redesigned Clock app in iOS 10.]({{ site.dropbox }}/listing-the-little-things/bedtime-screenshot.jpg)]({{ site.dropbox }}/listing-the-little-things/bedtime-screenshot.jpg)
</figure>
...
[![Screenshots showing how to edit the iOS Music App home screen]({{ site.dropbox }}/listing-the-little-things/music-app-composite.png)]({{ site.dropbox }}/listing-the-little-things/music-app-composite.png)
</figure>
...
<figure markdown="1" class="no-shadow">
[![Screenshots comparing collapsed vs. expanded iOS widgets]({{ site.dropbox }}/listing-the-little-things/widget-composite.png)]({{ site.dropbox }}/listing-the-little-things/widget-composite.png)
</figure>

### Setting A Preferred Transportation Type
...
<figure markdown="1" class="no-shadow">
[![Screenshots showing how to change iOS's preferred transportation setting]({{ site.dropbox }}/listing-the-little-things/preferred-transportation-composite.png)]({{ site.dropbox }}/listing-the-little-things/preferred-transportation-composite.png)
</figure>
...
<figure markdown="1" class="no-shadow">
[![Screenshots showing the watchOS Dock]({{ site.dropbox }}/listing-the-little-things/dock-composite.png)]({{ site.dropbox }}/listing-the-little-things/dock-composite.png)
</figure>
...
<figure markdown="1" class="no-shadow half-width">
[![A screenshot of the Watch iOS app displaying the new "Dock" preference pane.]({{ site.dropbox }}/listing-the-little-things/watch-app-composite.png)]({{ site.dropbox }}/listing-the-little-things/watch-app-composite.png)
</figure>
...
<figure markdown="1" class="watchos-screenshot">
