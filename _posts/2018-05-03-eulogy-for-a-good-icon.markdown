...
<figure markdown="1">
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/tower-2-icon-with-yosemite-background.jpg)]({{ site.dropbox }}/eulogy-for-a-good-icon/tower-2-icon-with-yosemite-background.jpg)
</figure>
...
<figure markdown="1">
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/tower-3-beta-signup-page.jpg)]({{ site.dropbox }}/eulogy-for-a-good-icon/tower-3-beta-signup-page.jpg)
</figure>
...
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/bad-os-x-icons.png)]({{ site.dropbox }}/eulogy-for-a-good-icon/bad-os-x-icons.png)
<figcaption>
...
<figure markdown="1" class="no-shadow">
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/snow-leopard-dock.png)]({{ site.dropbox }}/eulogy-for-a-good-icon/snow-leopard-dock.png)
</figure>
...
<figure markdown="1" class="no-shadow three-fours-size">
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/os-x-color-palettes.png){: .show-when-light }]({{ site.dropbox }}/eulogy-for-a-good-icon/os-x-color-palettes.png)
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/os-x-color-palettes-dark.png){: .show-when-dark }]({{ site.dropbox }}/eulogy-for-a-good-icon/os-x-color-palettes-dark.png)
...
<figure markdown="1" class="no-shadow">
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/lighting-comparison.png){: .show-when-light }]({{ site.dropbox }}/eulogy-for-a-good-icon/lighting-comparison.png)
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/lighting-comparison-dark.png){: .show-when-dark }]({{ site.dropbox }}/eulogy-for-a-good-icon/lighting-comparison-dark.png)
</figure>
...
<figure markdown="1" class="no-shadow">
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/app-genres.png){: .show-when-light }]({{ site.dropbox }}/eulogy-for-a-good-icon/app-genres.png)
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/app-genres-dark.png){: .show-when-dark }]({{ site.dropbox }}/eulogy-for-a-good-icon/app-genres-dark.png)
</figure>
...
<figure markdown="1" class="no-shadow high-sierra-dock">
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/high-sierra-dock.png){: .show-when-light }]({{ site.dropbox }}/eulogy-for-a-good-icon/high-sierra-dock.png)
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/high-sierra-dock-dark.png){: .show-when-dark }]({{ site.dropbox }}/eulogy-for-a-good-icon/high-sierra-dock-dark.png)
</figure>
...
<figure markdown="1" class="three-fours-size no-shadow">
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/macos-color-palettes.png){: .show-when-light }]({{ site.dropbox }}/eulogy-for-a-good-icon/macos-color-palettes.png)
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/macos-color-palettes-dark.png){: .show-when-dark }]({{ site.dropbox }}/eulogy-for-a-good-icon/macos-color-palettes-dark.png)
<figcaption>Palettes generated by <a href="https://www.canva.com/color-palette/">canva.com</a>.</figcaption>
</figure>
...
<figure markdown="1" class="no-shadow">
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/system-preferences-lit-and-unlit.png)]({{ site.dropbox }}/eulogy-for-a-good-icon/system-preferences-lit-and-unlit.png)
...
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/tower-3-icon.png)]({{ site.dropbox }}/eulogy-for-a-good-icon/tower-3-icon.png)
</figure>
...
<figure markdown="1" class="no-shadow">
[![]({{ site.dropbox }}/eulogy-for-a-good-icon/shadow-and-border-comparison.png)]({{ site.dropbox }}/eulogy-for-a-good-icon/shadow-and-border-comparison.png)
</figure>
