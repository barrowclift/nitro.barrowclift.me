...
<figure markdown="1">
[![Pokémon screen shot with "Welcome to the Cable Club!" text bubble]({{ site.dropbox }}/fearful-computing/cable-club.jpg)]({{ site.dropbox }}/fearful-computing/cable-club.jpg "Oh god, it begins...")
</figure>
...
<figure markdown="1">
[![Typical Windows desktop, lots of app icons everywhere]({{ site.dropbox }}/fearful-computing/windows-desktop.jpg)]({{ site.dropbox }}/fearful-computing/windows-desktop.jpg)
<figcaption>
...
[![Windows Explorer window showing Internet Explorer's folder contents]({{ site.dropbox }}/fearful-computing/internet-explorer.png)]({{ site.dropbox }}/fearful-computing/internet-explorer.png)
<figcaption>
...
<figure markdown="1">
[![Typical OS X desktop experience, desktop is clean of icons]({{ site.dropbox }}/fearful-computing/os-x-desktop.jpg)]({{ site.dropbox }}/fearful-computing/os-x-desktop.jpg "Amazing what some design competency can do, right?")
<figcaption>
