...
[![iOS Settings screenshots showing "Usage" location]({{ site.dropbox }}/home-sweet-home/settings-composite.png)]({{ site.dropbox }}/home-sweet-home/settings-composite-large.jpg)
</figure>
...
<figure markdown="1" class="no-shadow">
[![iOS app folder called "Creative"]({{ site.dropbox }}/home-sweet-home/creative-folder-composite.png)]({{ site.dropbox }}/home-sweet-home/creative-folder-composite.png)
</figure>

* __Games__: You guessed it, all games go here with the most played ones in the first page, nothing else to it, really.

<figure markdown="1" class="no-shadow">
[![iOS app folder called "Games"]({{ site.dropbox }}/home-sweet-home/games-folder-composite.png)]({{ site.dropbox }}/home-sweet-home/games-folder-composite.png)
</figure>
...
<figure markdown="1" class="no-shadow">
[![iOS app folder called "Media", containing Genius, Kodi Remote, Videos, iBooks, Cesium, Photos, Netflix, Barrowclift.me web shortcut, and Music]({{ site.dropbox }}/home-sweet-home/media-folder-composite.png)]({{ site.dropbox }}/home-sweet-home/media-folder.png)
</figure>
...
<figure markdown="1" class="no-shadow">
[![iOS app folder called "Services"]({{ site.dropbox }}/home-sweet-home/services-folder-composite.png)]({{ site.dropbox }}/home-sweet-home/services-folder-composite.png)
</figure>
...
[![My iOS Homescreen, contains folders Creative, Games, Media, and Services in the first row, then Tumblr, Tweetbot, narwhal, Paper, Unread, Instapaper, MiniHack, DN Paper, Weather Line, Calendar, Vesper, and Ecoute. In the dock there are Messages, Safari, and Overcast]({{ site.dropbox }}/home-sweet-home/home-screen-composite.png)]({{ site.dropbox }}/home-sweet-home/home-screen-composite-large.png)
</figure>
