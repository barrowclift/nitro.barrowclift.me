...
<figure markdown="1">
[![Image of Windows File Explorer screenshot. If you have difficulties seeing, or the image didn't load for some reason, just take my word for it that it looks like ass]({{ site.dropbox }}/fearful-computing/internet-explorer.png)]({{ site.dropbox }}/fearful-computing/internet-explorer.png)
<figcaption>
...
<figure markdown="1">
[![Image of a lovely macOS window screenshot]({{ site.dropbox }}/back-to-the-mac/screenshot-example.png){: .screenshot-example }]({{ site.dropbox }}/back-to-the-mac/screenshot-example.png)
</figure>
...
<figure markdown="1">
[![Image of the screen recording Quicktime window]({{ site.dropbox }}/back-to-the-mac/quicktime-screen-recording.png){: .quicktime }]({{ site.dropbox }}/back-to-the-mac/quicktime-screen-recording.png)
</figure>
...
Adding your own autocorrections couldn't be easier; open up System Preferences, click on the "Keyboard" item, and then select the "Text" tab. There, you can add whatever autocorrect substitutions you want to the table on the left.

<figure markdown="1">
[![Image of the text substitutions System Preferences pane]({{ site.dropbox }}/back-to-the-mac/custom-autocorrect-settings.png){: .custom-autocorrect}]({{ site.dropbox }}/back-to-the-mac/custom-autocorrect-settings.png)
</figure>
...
<figure markdown="1">
[![Image of the default Finder toolbar]({{ site.dropbox }}/back-to-the-mac/finder-default.png){: .finder-default }]({{ site.dropbox }}/back-to-the-mac/finder-default.png)
</figure>
...
<figure markdown="1">
[![Image of the Finder toolbar customization pane]({{ site.dropbox }}/back-to-the-mac/customize-toolbar-sheet.png){: .customize-toolbar-sheet }]({{ site.dropbox }}/back-to-the-mac/customize-toolbar-sheet.png)
</figure>
...
<figure markdown="1">
[![Image of my customized Finder toolbar]({{ site.dropbox }}/back-to-the-mac/finder-custom.png){: .finder-default }]({{ site.dropbox }}/back-to-the-mac/finder-custom.png)
</figure>
...
<figure markdown="1">
[![Image of the default Mail Compose toolbar]({{ site.dropbox }}/back-to-the-mac/mail-default.png){: .mail-default }]({{ site.dropbox }}/back-to-the-mac/mail-default.png)
<figcaption>
Default
</figcaption>
</figure>
...
[![Image of my custom Mail Compose toolbar]({{ site.dropbox }}/back-to-the-mac/mail-custom.png){: .mail-default }]({{ site.dropbox }}/back-to-the-mac/mail-custom.png)
<figcaption>
Custom
</figcaption>
</figure>
...
<figure markdown="1">
[![Image of the finder Preferences window]({{ site.dropbox }}/back-to-the-mac/finder-preferences.png){: .finder-preferences }]({{ site.dropbox }}/back-to-the-mac/finder-preferences.png)
</figure>
...
[![Image showing Auto the Automator robot and Wall-E's Eve side-by-side]({{ site.dropbox }}/back-to-the-mac/automator-and-eve.png)]({{ site.dropbox }}/back-to-the-mac/automator-and-eve.png)
</figure>
...
* [Change Image Format]({{ site.dropbox }}/downloads/back-to-the-mac/Change Image Format.zip)
* [Combine PDFs]({{ site.dropbox }}/downloads/back-to-the-mac/Combine PDFs.zip)
* [Convert Text to Audio File]({{ site.dropbox }}/downloads/back-to-the-mac/Convert Text to Audio File.zip)
* [Make PDF from Images]({{ site.dropbox }}/downloads/back-to-the-mac/Make PDF from Images.zip)
* [Rename Files Sequentially]({{ site.dropbox }}/downloads/back-to-the-mac/Rename Files Sequentially.zip)
...
* [*Mac OS X Automation* - "Tutorial 04: Recording"](https://macosxautomation.com/training/automator/tut04/02.html)
* [*Hacks for Macs* - "Controlling the GUI via Automator"](https://hacksformacs.wordpress.com/2013/05/27/controlling-the-gui-via-automator/)
* [*Peachpit TV* - "Recording Manual Events in Automator with Ben Waldie"](https://www.youtube.com/watch?v=5o_JrForn6Y)
...
<figure markdown="1">
[[![Loads of Finder "Get Info" windows, LOADS OF THEM]({{ site.dropbox }}/back-to-the-mac/death-by-get-info.jpg)]({{ site.dropbox }}/back-to-the-mac/death-by-get-info.jpg)]({{ site.dropbox }}/back-to-the-mac/originals/death-by-get-info.jpg)
<figcaption>
God dammit, Apple...
</figcaption>
</figure>
...
<figure markdown="1">
[![The consolidated Finder "Get Info" window]({{ site.dropbox }}/back-to-the-mac/consolidated-get-info-window.png){: .get-info }]({{ site.dropbox }}/back-to-the-mac/consolidated-get-info-window.png)
</figure>
...
If you've always found yourself gravitating towards dark backgrounds, you owe it to yourself to give Dark Mode a spin if you haven't already[^website-dark-mode]. Enabling it's as easy as opening up System Preferences and clicking the "Use dark menu bar and Dock" checkbox in the "General" Preference Pane. Below's a screenshot of my Desktop with the setting enabled to give you an idea of what to expect.

<figure markdown="1">
[![Image of my desktop with Dark Mode enabled]({{ site.dropbox }}/back-to-the-mac/dark-mode.jpg)]({{ site.dropbox }}/back-to-the-mac/dark-mode.jpg)]({{ site.dropbox }}/back-to-the-mac/originals/dark-mode.jpg)
</figure>
...
[^i-guess]: <a href="http://www.gunshowcomic.com/367"><img alt="I GUESS" class="i-guess" src="{{ site.dropbox }}/back-to-the-mac/i-guess.png" /></a>
[^finder]: Although, there's no denying he's utterly adorable.<img class="finder no-shadow" alt="Fin the Finder" src="{{ site.dropbox }}/back-to-the-mac/finder.png" />
...
[^dock]: <img alt="MacBook screenshot showcasing the space taken up by the Dock" class="macbook" style="border-radius:0.25em" src="{{ site.dropbox }}/back-to-the-mac/macbook-dock.jpg"/>
